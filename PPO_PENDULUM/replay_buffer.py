...
class ReplayBuffer:
    def __init__(self, value_network, gamma=0.99, gae_lambda=0.95, max_size=100000, observation_shape=(3,), action_shape=(1,)):
    ...
    def cal_targ_agv(self):
        ...
        all_states = tf.convert_to_tensor(self.all_observation_memory[:max_mem+1],dtype=tf.float32)
